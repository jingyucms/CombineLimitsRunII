...
outDir="/afs/cern.ch/user/f/fengwang/workplace/CombinedLimits/CMSSW_10_2_18/src/CombineLimitsRunII/outputRooDataset/TauMuTauHad_V2/"
    ...
    for h in mh:
        for ia,a in enumerate(hamap[h]):
            for ir,r in enumerate(regions):
                ...
                globals()["visFourbodyMass" + a + r] = ROOT.RooRealVar("visFourbodyMass", "visFourbodyMass", 0, 1200)
                globals()["eventWeight" + a + r] = ROOT.RooRealVar("eventWeight", "eventWeight", 0, 1)
