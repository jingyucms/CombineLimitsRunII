...
#foreach year (2018)
	...
	python haaLimitsDevToolsRunII.py mm h --unblind --parametric --addControl --fitParams --unbinned --xRange 11 26  --yRange 50 150 --tag highmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeTauScaleFit_PPonly --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log3${year} &
	...
	python haaLimitsDevToolsRunII.py mm h --unblind --parametric --fitParams --addControl --unbinned --xRange 11 26 --yRange 50 150 --tag highmass_${channel}_${year}_MVAMedium_DG_DoubleExpo_yRange_wFakeJECFit_PPonly --channel ${channel}_${year} --yFitFunc DG --doubleExpo >& log3${year} &
