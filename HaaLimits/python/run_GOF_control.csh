...
#foreach channel (TauMuTauHad_V2 TauHadTauHad_V3)
	...
	foreach algo (saturated)
		...
		setenv amass 15.0
            ...
            setenv workDir GOF_control_${region}_${algo}_${year}
            if ($Tfunc == all) then
            ...
            cd $workDir
            combine -M GoodnessOfFit -d ../${datacard}.root --algo=${algo} -n _${channel}_${region}_${algo} -m 125 --freezeParameters MA --setParameters MA=${amass} --setParametersForFit mask_TauMuTauHad_V2_${year}_PP=0 --setParametersForEval mask_TauMuTauHad_V2_${year}_PP=1
            combine -M GoodnessOfFit -d ../${datacard}.root --algo=${algo} -n _${channel}_${region}_${algo} -m 125 --freezeParameters MA --setParameters MA=${amass} --setParametersForFit mask_TauMuTauHad_V2_${year}_PP=0 --setParametersForEval mask_TauMuTauHad_V2_${year}_PP=1 -t 100 -s 1234
