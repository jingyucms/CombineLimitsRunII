...
#combine -M AsymptoticLimits -v 2 --noFitAsimov -m ${1} --setParameters MA=${2} --rMin 0 --rMax 20 --X-rtd TMCSO_AdaptivePseudoAsimov=0 --X-rtd TMCSO_PseudoAsimov=0 --freezeParameters=MA ${3} -n ${4}

combine -M AsymptoticLimits --unbinned  -v 2 -m ${1} --setParameters MA=${2} --rMin -3 --rMax 10 --freezeParameters=MA ${3} -n ${4}
