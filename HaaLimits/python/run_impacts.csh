...
#foreach channel (allchs)
	...
	#foreach year (all)
		...
		#setenv datacard mmmt_mm_h_parametric_unbinned_${region}_${channel}_${year}_${Tfunc}_hm${h}_amX
            ...
            #combineTool.py -M Impacts -m 125 --unbinned --setParameters MA=${amass} --freezeParameters MA --setParameterRanges MA=${amass},${amass} --rMin -3 --rMax 3 --robustFit 1 -d ../${datacard}.root --doFits --parallel 10
            #combineTool.py -M Impacts -m 125 --unbinned --setParameters MA=${amass} --freezeParameters MA --setParameterRanges MA=${amass},${amass} --rMin -3 --rMax 3 --robustFit 1 -d ../${datacard}.root --output impacts.json
