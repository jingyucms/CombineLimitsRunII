...
rfile = '../../HaaLimits/python/datacards_shape/MuMuTauTau/mmmt_mm_{}_parametric_unbinned_{}_TauETauHad_2018_MVAMedium_DG_yRange_wFakeTauScaleFit_PPonly.root'.format(yvar,massRange)
